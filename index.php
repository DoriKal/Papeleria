...
FROM empleado e INNER JOIN persona p ON p.idPersona= e.persona_idPersona 
WHERE e.usu='$usu' and e.con ='$con'");				
            ...
            $_SESSION['idUser']=$row['idUsuario'];
					if($row['tipo']=='a'){
						...
						echo mensajes('Bienvenido Cajero<br>'.$row['nom'].' '.$row['ape'].'','verde').'<br>';
						echo '<center><img src="img/ajax-loader.gif"></center><br>';
						echo '<meta http-equiv="refresh" content="2;url=Principal.php">';
					}
				}else{
