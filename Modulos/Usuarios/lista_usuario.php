                        ...
                        <center>
                      	<form name="form3" method="post" action="" class="form-search">
                        	<div class="input-prepend input-append">
                                ...
                                autofocus placeholder="Buscar Alumnos por Usuario o Nombres">
                            </div>
                    ...
                    <td width="20%"><strong><center>Tipo de Usuario</center></strong></td>
                  	...
                  	<?php 
    				  		  if(!empty($_POST['buscar'])){ 
    							   ...
    							   $pa=mysql_query("SELECT * FROM persona INNER JOIN empleado ON persona.idPersona=empleado.persona_idPersona
                      WHERE persona.doc='$buscar' or persona.nom LIKE '%$buscar%' or persona.ape LIKE '%$buscar%'");				
