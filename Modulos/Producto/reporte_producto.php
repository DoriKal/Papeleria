        ...
        <table width="90%">
          <tr>
            ...
            <table class="table table-bordered">
              <tr class="well">
                <td><h2 align="center">Existencia General de Articulos</h2></td>
              </tr>
            </table>
            <div class="row-fluid">
                <div class="span12">
                    <table class="table table-bordered">
                        <tr>
                            <td>
                                ...
                                <div id="imprimeme">
                                    <center><strong>Productos Con Existencia </strong></center>
                                    <table width="95%">
                                        <tr>
                                            <td>
                                                <center>
...
ORDER BY a.codigo");              
                                        ...
                                        ?>
                                            <?php if($row['existencia'] >= $row['stockMinimo'] && $row['existencia'] > 0 && $row['stockMinimo'] > 0 ){ ?>
                                                <tr>
