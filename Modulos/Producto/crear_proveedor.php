            ...
            <td>
                ...
                <?php 
					if(!empty($_POST['proveedor_e'])){
						...
						$pa=mysql_query("SELECT * FROM detalleprov WHERE producto_codigo='$id_codigo' and proveedor_id='$proveedor_e'");				
                        if($row=mysql_fetch_array($pa)){
							echo mensajes('Este Proveedor "'.$nombre_prov.'" ya se Encuentra Relacionado con el Producto "'.$nombre_producto.'"','rojo');
						}else{
							mysql_query("INSERT INTO detalleprov (producto_codigo, proveedor_id) VALUES ('$id_codigo','$proveedor_e')");
					...
					if(!empty($_POST['nombre']) and !empty($_POST['dir'])){
						...
						mysql_query("INSERT INTO detalleprov (producto_codigo, proveedor_id) VALUES ('$id_codigo','$max_prov')");
                ...
                <table class="table table-bordered table table-hover">
                  ...
                  <?php
					if($existe==TRUE){				  				  	
						$pa=mysql_query("SELECT * FROM detalleprov WHERE producto_codigo='$id_codigo'");				
						while($row=mysql_fetch_array($pa)){
							$oProveedor=new Consultar_Proveedor($row['proveedor_id']);
				  ?>
                  <tr>
