    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <div align="right">
	                <a href="#nuevo" role="button" class="btn" data-toggle="modal"><strong>Crear Nueva Sucursal</strong></a>
                </div>
                ...
                <div id="nuevo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 id="myModalLabel">Crear Sucursal</h3>
                    </div>
                    ...
                    <div class="modal-footer">
        	            ...
        	            <button type="submit" class="btn btn-primary"><strong>Registrar Sucursal</strong></button>
                    </div>
                    </form>
                </div>
                ...
                <table class="table table-bordered">
				  ...
				  <?php 
				  	if(!empty($_POST['buscar'])){
						...
						$pame=mysql_query("SELECT * FROM sucursal WHERE nombre LIKE '%$buscar%' ORDER BY nombre");	
					}else{
						$pame=mysql_query("SELECT * FROM sucursal ORDER BY nombre");		
					}		
                  ...
                  <tr>
                    ...
                    <td>
                    	<center>
                            <a href="#act<?php echo $row['idDeposito']; ?>" role="button" class="btn btn-mini" data-toggle="modal">
                                <i class="icon-edit"></i>
                            </a>
                        </center>
                    </td>
                  </tr>
                  <div id="act<?php echo $row['idDeposito']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                	<form name="form2" method="post" action="">
                    <input type="hidden" name="id" value="<?php echo $row['idDeposito']; ?>">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h3 id="myModalLabel">Actualizar Sucursal</h3>
                    </div>
                    <div class="modal-body">
                        <div class="row-fluid">
                            <div class="span6">
                    ...
                    <div class="modal-footer">
    	                <button class="btn" data-dismiss="modal" aria-hidden="true"><strong>Cerrar</strong></button>
        	            <button type="submit" class="btn btn-primary"><strong>Actualizar Sucursal</strong></button>
                    </div>
                    </form>
                </div>
                  <?php } ?>
