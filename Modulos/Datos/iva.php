    	...
    	<table width="90%">
          <tr>
            <td>
                ...
                <?php 
					if(!empty($_POST['nombreIva'])){
						$id=limpiar($_POST['idIva']);
						$nombre=limpiar($_POST['nombreIva']);
						$valor=limpiar($_POST['valor']);
						$estado=limpiar($_POST['estado']);
						$overty=new Consultar_IVA($id);
						if($overty->consultar('nombreIva')==NULL){
                        	...
                        	<div class="row-fluid">
                            	<div class="span6">
                                	<table class="table table-bordered table table-hover">
                                      ...
                                      <?php
									  	$pame=mysql_query("SELECT * FROM iva ORDER BY nombreIva");			
										while($row=mysql_fetch_array($pame)){
											$url=cadenas().encrypt($row['idIva'],'URLIVACODIGO');
									  ?>
                                      <tr>
                                        <td><center><?php echo $row['idIva']; ?></center></td>
                                        <td><?php echo $row['nombreIva']; ?></td>
                                      ...
                                      <tr>
                                      	<td>
                                        	<div align="center">
                                                ...
                                                <input type="text" name="idIva" value="<?php echo $id_iva; ?>" readonly autocomplete="off"><br>
                                                <strong>Descripcion</strong><br>
                                                <input type="text" name="nombreIva" value="<?php echo $nombre_iva; ?>" required autocomplete="off"><br>
